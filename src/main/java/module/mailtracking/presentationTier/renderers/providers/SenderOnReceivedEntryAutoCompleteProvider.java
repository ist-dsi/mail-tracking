/*
 * @(#)SenderOnReceivedEntryAutoCompleteProvider.java
 *
 ...
 * 
 */
public class SenderOnReceivedEntryAutoCompleteProvider implements AutoCompleteProvider<AutoCompleteValueWrapper> {
